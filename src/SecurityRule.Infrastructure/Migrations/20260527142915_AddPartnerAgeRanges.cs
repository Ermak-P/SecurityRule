...
{
    /// <inheritdoc />
    public partial class AddPartnerAgeRanges : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AgeOptions", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "PartnerAgeRanges",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerAgeRanges", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartnerAgeRanges_AppServices_AppServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AgeOptions_Value",
                table: "AgeOptions",
                column: "Value",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PartnerAgeRanges_AppServiceId",
                table: "PartnerAgeRanges",
                column: "AppServiceId");
        }
